# -*- coding: utf-8 -*-
"""Precision score implementation.
...
class PrecisionScore(interface.Metric):
    """Data structure for storing the precision score during run time."""

    metric_type: interface.MetricType = interface.MetricType.PRECISION
    ...
    def measure(
        ...
        """Measure model performance using Precision score.
        ...
        f1_score = sklearn_metrics.precision_score(
